      ...
      <div className="flex justify-center ">
        <div className="w-full bg-transparent p-4 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          <form className="max-w-3xl mx-auto">
            ...
            <label
              class="block mb-2 text-sm font-medium bg-transparent text-white dark:text-white"
              for="file_input"
            >
              Choose file
            </label>
            <input
              class="block mb-4 w-full text-sm text-white border border-gray-300 rounded-lg cursor-pointer bg-transparent dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
              id="file_input"
              type="file"
            />
            <label
            ...
            <textarea
              id="message"
              rows="4"
              class="block p-2.5 w-full text-sm text-white focus:outline-none bg-transparent rounded-lg border focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 placeholder-white dark:placeholder-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
